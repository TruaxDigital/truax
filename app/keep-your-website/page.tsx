...
function KeepYourWebsiteContent() {
  ...
  return (
    <main className="bg-white text-[#0A0A0A] antialiased">
      {/* Nav */}
      <header className="bg-black sticky top-0 z-40 border-b border-black">
        <div className="max-w-6xl mx-auto px-5 md:px-8 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <img 
              src="https://truaxmarketing.com/wp-content/uploads/2023/12/truax-logo.svg" 
              alt="Truax Marketing Solutions" 
              className="h-7 w-auto brightness-0 invert"
            />
          </Link>
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-white/70">
            <a href="#what-happened" className="hover:text-white transition">What happened</a>
            <a href="#offer" className="hover:text-white transition">The offer</a>
            <a href="#faq" className="hover:text-white transition">FAQ</a>
          </nav>
          <a 
            href="#offer" 
            className="bg-white text-black px-4 py-2 rounded-md text-sm font-semibold hover:bg-gray-100 transition"
          >
            Keep my site
          </a>
        </div>
      ...
      <footer className="bg-black text-white/60 border-t border-white/10">
        <div className="max-w-6xl mx-auto px-5 md:px-8 py-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-x-8 gap-y-2 text-sm font-medium">
            <a href="https://truaxmarketing.com" target="_blank" rel="noopener noreferrer" className="hover:text-white">truaxmarketing.com</a>
            <a href="mailto:aaron@truaxmarketing.com" className="hover:text-white">aaron@truaxmarketing.com</a>
            <a href="tel:8582209501" className="hover:text-white">858-220-9501</a>
          </div>
          <div className="text-xs">&copy; {new Date().getFullYear()} Truax Marketing Solutions. All rights reserved.</div>
        </div>
      </footer>
    </main>
  );
