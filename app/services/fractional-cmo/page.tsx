...
export default function FractionalCMOPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a12]">
      ...
      {/* Hero Section */}
      <section className="relative min-h-screen flex items-center overflow-hidden pt-24 pb-20 px-6">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-1/4 w-[600px] h-[400px] bg-gradient-to-br from-[#27AAE1]/10 via-[#2B3990]/8 to-transparent rounded-full blur-3xl" />
          <div className="absolute bottom-1/4 right-0 w-[500px] h-[500px] bg-gradient-to-tl from-[#2B3990]/15 to-transparent rounded-full blur-3xl" />
        </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              >
                Trusted by PE-backed and growth-stage companies
              </motion.p>
            </div>
