          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative aspect-square max-w-lg mx-auto rounded-3xl overflow-hidden border border-[#262466] shadow-2xl shadow-[#27AAE1]/10">
                <img 
                  src="/images/services/demand-gen-hero.jpg" 
                  alt="Abstract visualization of pipeline growth with ascending funnel and conversion flows"
      ...
      <section className="py-20 px-6 border-t border-[#262466]/50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-semibold tracking-tight">Latest on Demand Generation</h2>
          </motion.div>
          <div className="grid md:grid-cols-3 gap-8">
            {getPostsByKeywords(["demand generation", "lead generation", "pipeline", "paid media", "linkedin ads", "google ads", "abm"], 3).map((post, index) => (
              <motion.article
                key={post.slug}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                    ...
                    {(() => {
                      ...
                      return imageUrl ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          <BarChart3 className="h-10 w-10 text-[#27AAE1]/40" />
                        </div>
                      );
                    })()}
                  </div>
