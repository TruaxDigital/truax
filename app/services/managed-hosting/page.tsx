          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="relative aspect-square max-w-lg mx-auto">
                ...
                <div className="absolute top-8 left-8 w-24 h-24 bg-[#27AAE1]/20 rounded-lg" />
                <div className="absolute top-12 right-16 w-32 h-32 border-2 border-[#2B3990]/40 rounded-full" />
                <div className="absolute bottom-20 left-20 w-16 h-16 bg-[#27AAE1]/30 rounded-xl rotate-12" />
                <div className="absolute bottom-12 right-12 w-28 h-4 bg-[#2B3990]/40 rounded-full" />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-[#27AAE1] rounded-lg opacity-60" />
              </div>
            </motion.div>
          </div>
        </div>
